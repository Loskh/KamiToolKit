...
public unsafe class CollisionNode : NodeBase<AtkCollisionNode> {
    public CollisionNode() : base(NodeType.Collision) {
    }

    public CollisionNode(AtkCollisionNode* collisionNode) : base(collisionNode) {
    }
